...
ln_setup_attract_mame_generate="Generating games list..."
ln_setup_attract_mame_version="MAME version installed :"
ln_setup_attract_mame_games="Number of mame games analyzed :"
ln_setup_attract_mame_import="Importing games list..."
ln_setup_attract_done="ATTRACT setup done."
